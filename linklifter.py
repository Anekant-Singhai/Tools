...
#                     print(f"{Fore.LIGHTMAGENTA_EX} 🢂 {link}{Style.RESET_ALL}\n")
#             # Print the comments:
#                 print(f"---------------------- THE Comments: -------------------")
#                 #for comment in comments:
#                 print(f"{Fore.LIGHTMAGENTA_EX} 🢂 {comments}{Style.RESET_ALL}\n")
...
class linklifter:
    def extract_url(self,url, output_file, js_only, links_only):
        try:
            ...
            links_js = set()
            links_css = set()
            comments = soup.find_all(string=lambda text: isinstance(text, Comment))  # Extract comments
            ...
            if not js_only:
                ...
                print(f"---------------------- THE Comments: -------------------")
                for comment in comments:
                    print(f"{Fore.LIGHTMAGENTA_EX} 🢂 {comment}{Style.RESET_ALL}\n")
